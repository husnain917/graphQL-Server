...
export const UPDATE_SINGLE_SUCCESS = gql`
  mutation UpdateSuccessStories(
    $where: SuccessStoriesWhereUniqueInput!
    $data: SuccessStoriesUpdateInput!
  ) {
...
export const UPDATE_SINGLE_ENROLLMENT = gql`
  mutation UpdateEnrollmentApproval(
    $data: EnrollmentApprovalUpdateInput!
...
export const UPDATE_QUIZ = gql`
  mutation UpdateCourseQuiz(
    $data: CourseQuizUpdateInput!
...
export const UPDATE_ASSIGNMENT = gql`
  mutation UpdateCourseAssignment(
...
export const UPDATE_COURSE_BATCH = gql`
  mutation UpdateCourseBatches(
    $data: CourseBatchesUpdateInput!
...
export const UPDATE_MY_COURSE = gql`
  mutation UpdateMyCourse(
    $data: MyCourseUpdateInput!
